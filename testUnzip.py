...
def getFirstImagePath():
    print(os.listdir("./tempFolderName"))
    filename = os.listdir("./tempFolderName")[0]
    print(os.listdir("./tempFolderName")[0])
...
extractDateTime(r"C:\Users\benjw\Downloads\drive-download-20230718T191808Z-001\PXL_20230713_183725567.jpg")
# returnFolderName()
